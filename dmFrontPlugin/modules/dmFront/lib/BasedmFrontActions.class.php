...
class BasedmFrontActions extends dmFrontBaseActions
{
    ...
    public function executeCachedPage(dmWebRequest $request)
    {
		...
		$this->setTemplate('pageCache');
		$this->setLayout(sfConfig::get('sf_root_dir').'/apps/front/modules/dmFront/templates/pageCacheLayout');

		$this->helper = $this->getService('page_helper');	
        
        sfConfig::set('dm_page_cached_via_page_cache', true);
