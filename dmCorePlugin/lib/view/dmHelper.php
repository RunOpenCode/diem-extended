...
class dmHelper extends dmConfigurable
{
     ...
     */
    public function parseRichContent($content, $removeAttributes = true, $removeMissingElements = true)
    {
        return $this->serviceContainer->getService('rich_content_parser')->parse($content, $removeAttributes, $removeMissingElements);
    }
