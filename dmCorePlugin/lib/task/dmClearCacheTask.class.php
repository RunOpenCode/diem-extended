...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    {
      $this->logSection('Diem Extended', 'Cache successfully cleared');
    }
    else
    {
      $this->logSection('Diem Extended', 'Some files can not be deleted. Please check permissions in /cache dir');
    }
  }
}
